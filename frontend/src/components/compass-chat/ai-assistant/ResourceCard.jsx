...
export default function ResourceCard({ title, description, link }) {
    ...
    return (
        ...
        >
            ...
            {description && <p className="text-meta text-ink-70 leading-relaxed mt-1">{description}</p>}
            {link && (
                <span className="inline-flex items-center gap-1 mt-2 text-meta font-medium text-mint-700 group-hover:gap-1.5 transition-all">
